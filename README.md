...
Versions:
 ...
 - [0.21.2-beta](https://hub.docker.com/layers/btcpayserver/lnd/v0.21.2-beta/images/sha256-809977c805455196dc6f9334ac4ee666002cc244eb5b58224a0d6c2d167f0afc?context=repo)
    - Includes 0.33.3-beta Loop
 - [0.21.1-beta](https://hub.docker.com/layers/btcpayserver/lnd/v0.21.1-beta/images/sha256-cac93abe645c6bf4bca2c9c7118bd089976c1d6c08045f922775a31864165a6c?context=repo)
    - Includes 0.33.3-beta Loop
 - [0.21.0-beta](https://hub.docker.com/layers/btcpayserver/lnd/v0.21.0-beta/images/sha256-70de68dc14e34826f25496f6ec294b096b294698670e2ecc8555e0790e7383e5?context=repo)
    - Includes 0.33.3-beta Loop
 - [0.19.3-beta-1](https://hub.docker.com/layers/btcpayserver/lnd/v0.19.3-beta-1/images/sha256-d5f1cb925128d2fd9cd5454b4e2e2a8dff28d8def6018827349ae07d8fe386c6?context=repo)
    - Includes 0.31.2-beta Loop
 - [0.19.1-beta](https://hub.docker.com/layers/btcpayserver/lnd/v0.19.1-beta/images/sha256-d56f6e57794ebc4aa0119e5ec91b1aa076ceaa324cad0d816cbf282fb0a3a2d0?context=repo)
    - Includes 0.29.0-beta Loop
...
1. **Update https://github.com/btcpayserver/lnd**
   ...
   e) The build process will start (the workflow [matches on tag format](.github/workflows/publish.yml) and requires the `DOCKERHUB_USERNAME`/`DOCKERHUB_TOKEN` repo secrets). Watch the run under the repo's [Actions tab](https://github.com/btcpayserver/lnd/actions).  
...
2. **Update https://github.com/btcpayserver/BTCPayServer.Lightning**
   ...
   d) Open a pull request and reference Docker Hub and Tag. [Example PR](https://github.com/btcpayserver/BTCPayServer.Lightning/pull/194).
...
3. **Update https://github.com/btcpayserver/btcpayserver**
   ...
   a) Modify 4 `docker-compose.yml` files in `BTCPayServer.Tests`. [Example pull request to emulate](https://github.com/btcpayserver/btcpayserver/pull/7547).  
...
4. **Update https://github.com/btcpayserver/btcpayserver-docker**
   ...
   a) Now that everything is prepared, open a PR in the btcpayserver-docker repository to allow these changes to propagate to everyone. [Example pull request](https://github.com/btcpayserver/btcpayserver-docker/pull/1093).  
